...
import { ArrowLeft, AudioLines, Calendar, FileText, Hash, MapPin, NotebookPen, Phone, Plus, User } from 'lucide-react';
...
const PatientPage = () => {
    ...
    const [selectedNoteId, setSelectedNoteId] = useState<number | 'new'>();
    const [refreshTrigger, setRefreshTrigger] = useState(0);
    const notes = usePatientNotes(id, refreshTrigger);
    ...
    const selectedNote = selectedNoteId === 'new' ? 'new' : notes.find((note) => note.id === selectedNoteId);
                ...
                <ResizablePanelGroup direction="horizontal" className="h-full">
                                ...
                                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                                    ...
                                    <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                                        ...
                                        <Button
                                            ...
                                            className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-lg transition-all duration-200"
                                        >
                                ...
                                <div className="space-y-2">
                                            ...
                                            >
                                                <Card
                                                    className={cn(
                                                        ...
                                                        selectedNote && typeof selectedNote !== 'string' && selectedNote.id === note.id
                                    ...
                                    {!notes.length && (
                                        ...
                                        >
                                            ...
                                            <p className="text-gray-400 text-xs">Click "New Note" to create your first
                                                note</p>
                                        </motion.div>
                                    )}
                                </div>
                    ...
                    <ResizablePanel defaultSize={50} minSize={30}>
                        <section className="bg-white overflow-y-auto h-full">
                            {selectedNote ? (
                                <NoteDetails note={selectedNote} patient={patient} onNoteUpdate={handleNoteUpdate} />
                            ) : (
...
export function usePatientNotes(patientId: string, refreshTrigger = 0) {
